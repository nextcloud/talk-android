...
class MessageSenderTest {
    ...
    ) : com.nextcloud.talk.call.MessageSender(signalingMessageSender, callParticipants, peerConnectionWrappers) {
    ...
    fun setUp() {
        ...
        messageSender = MessageSender(signalingMessageSender, callParticipants, peerConnectionWrappers)
    }
