...
public class PushConfigurationState {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PushConfigurationState)) return false;
        ...
        if (this$pushToken == null ? other$pushToken != null : !this$pushToken.equals(other$pushToken)) return false;
        ...
        if (this$userPublicKey == null ? other$userPublicKey != null : !this$userPublicKey.equals(other$userPublicKey))
            return false;
        if (this.isUsesRegularPass() != other.isUsesRegularPass()) return false;
        return true;
    }
