...
import com.nextcloud.talk.utils.NotificationUtils.calculateCRC32
...
@Suppress("LongMethod", "CyclomaticComplexMethod", "LargeClass", "TooManyFunctions")
...
class NotificationWorker(context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
    ...
    override fun doWork(): Result {
        ...
        if (pushMessage.delete) {
            ...
            when (pushMessage.type) {
                ...
                else -> Log.e(TAG, pushMessage.type + " isn't handled")
            }
    ...
    fun NotificationCompat.Builder.handleExistingBubble(
        ...
        val preservedBubbleBuilder = when {
            ...
            else -> return this.addBubbleMetadata(existingBubble.isNotificationSuppressed)
        }
        ...
        this.setBubbleMetadata(preservedMetadata)

        val existingShortcut = compatBubble.shortcutId

        return if (!existingShortcut.isNullOrEmpty()) {
            this.applyShortcutAndLocus(existingShortcut)
        } else {
            this.applyShortcutAndLocus(effectiveShortcutId)
        }
    }
    ...
    private fun handleBubble(
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R || effectiveShortcutId == null) {
    ...
    companion object {
        ...
        const val BUBBLE_SWITCH_KEY = "bubble_switch"
