...
public class AllAccountRemovalWorker extends Worker {
    public static final String TAG = "AllAccountRemovalWorker";
    ...
    public AllAccountRemovalWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
                                        ...
                                        ncApi.unregisterDeviceForNotificationsWithProxy
                                                ...
                                                .subscribe(new Observer<Void>() {
                                                    ...
                                                    public void onNext(Void aVoid) {
                                                        ...
                                                        arbitraryStorageUtils.deleteAllEntriesForAllAccount(userEntity.getId()).subscribe(new Observer() {
                                                            @Override
                                                            public void onSubscribe(Disposable d) {
                                                            ...
                                                            public void onNext(Object o) {
                                                                userUtils.deleteAllUser().subscribe(new CompletableObserver() {
                                                                    @Override
                                                                    public void onSubscribe(Disposable d) {
