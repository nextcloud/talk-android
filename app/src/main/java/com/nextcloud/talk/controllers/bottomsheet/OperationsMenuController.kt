...
class OperationsMenuController(args: Bundle) : NewBaseController(
    ...
    private fun chatApiVersion(): Int {
        return ApiUtils.getChatApiVersionNew(currentUser, intArrayOf(ApiUtils.APIv1))
    }
    ...
    private fun checkCapabilities(currentUser: User) {
        ...
        ApiUtils.getChatApiVersionNew(currentUser, intArrayOf(1))
        ApiUtils.getSignalingApiVersionNew(currentUser, intArrayOf(ApiUtils.APIv3, 2, 1))
    }
