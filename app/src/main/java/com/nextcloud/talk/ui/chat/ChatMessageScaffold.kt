...
fun MessageScaffold(
    ...
    fun shouldShowTimeNextToContent(message: ChatMessageUi): Boolean {
        if (forceTimeBelow) return false
...
//         },
//         update = { view ->
//             val processedMessageText = messageUtils.enrichChatMessageUiText(
...
//             view.text = "" + processedMessageText + " (" + message.id + ")"
//         },
//         modifier = Modifier
//     )
// }
