...
object DeepLinkHandler {
    ...
    private fun parseNextcloudTalkUri(uri: Uri): DeepLinkResult? {
        ...
        // Extract optional username and server host from authority
        ...
        // Extract room token from path
        val token = extractTokenFromPath(path) ?: return null
        ...
        // Build server URL (always use https for security)
        val serverUrl = "https://$serverHost"
