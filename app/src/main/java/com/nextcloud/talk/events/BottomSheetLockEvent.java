...
public class BottomSheetLockEvent {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BottomSheetLockEvent)) return false;
        ...
        if (this.isShouldRefreshData() != other.isShouldRefreshData()) return false;
        if (this.isCancel() != other.isCancel()) return false;
        if (this.isDismissView() != other.isDismissView()) return false;
        return true;
    }
