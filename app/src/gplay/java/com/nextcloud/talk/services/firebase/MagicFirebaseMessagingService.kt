...
class MagicFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        Logging.d(TAG, "onMessageReceived(RemoteMessage)")
        sharedApplication!!.componentApplication.inject(this)
    ...
    private fun decryptMessage(subject: String, signature: String) {
        ...
        try {
            ...
            try {
                ...
                if (signatureVerification!!.signatureValid) {
                    ...
                    decryptedPushMessage?.apply {
                        ...
                        if (delete) {
                            ...
                            Logging.d(TAG, "    executing startForeground. " +
                            ...
                            Logging.d(TAG, "    else....(none of delete/deleteAll/call)")
                ...
                Log.e(TAG, "No proper algorithm to decrypt the message " + e1.localizedMessage)
            } catch (e1: NoSuchPaddingException) {
                Log.e(TAG, "No proper padding to decrypt the message " + e1.localizedMessage)
            } catch (e1: InvalidKeyException) {
                Log.e(TAG, "Invalid private key " + e1.localizedMessage)
            }
        } catch (exception: Exception) {
            Log.e(TAG, "Something went very wrong " + exception.localizedMessage)
        }
    }
